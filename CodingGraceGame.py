...
def start_new_adventure(player_info_arg):
    ...
    while True:
        print_new_dungeon()
        print("You see seven doors: red, blue, green, purple, pink, yellow, and white.")
        door_picked = input("Which door do you choose? > ")
        door = door_picked.strip().lower()


        # -- Original three rooms (unchanged) ------------------------------------------
        ...
        # -- New rooms - added by Integrator after merging PRs ------------------------------------------
        elif door.startswith("purple"):
            room_result = purple_shadow_realm_room(player_info_arg)
        elif door.startswith("pink"):
            room_result = pink_floral_hall_room(player_info_arg)
        elif door.startswith("yellow"):
            room_result = yellow_lemon_farm_room(player_info_arg)
        elif door.startswith("white"):
            room_result = white_crystal_boba_room(player_info_arg)
        else:
            print("Please enter one of the seven door names.")
